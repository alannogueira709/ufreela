...
export const NotificationIcon: React.FC<IconProps> = ({ type }) => {
  const configs: Record<NotificationType, { bg: string; icon: React.ReactNode }> = {
    ...
    profile_completion: {
      ...
      icon: (
        <svg className="w-4 h-4 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 15.91a4.5 4.5 0 01-1.897 1.13L6 18l.96-2.685a4.5 4.5 0 011.13-1.897L16.862 4.487zM19.5 7.125L16.875 4.5" />
        </svg>
      ),
    },
  };
